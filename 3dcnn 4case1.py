...
if __name__ == '__main__':
    ...
    if status == 'Training':
        ...
        model.compile(optimizer=optimizer,
                      ...
                      metrics=['accuracy'])
        #记录实验结果到Tensorboard 
        tensorboard = keras.callbacks.TensorBoard(log_dir=os.path.join('record1'))
        checkpoint = keras.callbacks.ModelCheckpoint(filepath=os.path.join('record1','Test2attention1.hdf5'), save_best_only=True,save_weights_only=True)
        model.fit_generator(
