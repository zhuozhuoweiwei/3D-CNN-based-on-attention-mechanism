...
if __name__ == '__main__':
    ...
    if status == 'Training':
        ...
        model.compile(optimizer=optimizer,
                      ...
                      metrics=['accuracy'])
        tensorboard = keras.callbacks.TensorBoard(log_dir=os.path.join('record4'))
        checkpoint = keras.callbacks.ModelCheckpoint(filepath=os.path.join('record4','3dcnnwithoutattention1.hdf5'), save_best_only=True,save_weights_only=True)
        model.fit_generator(
